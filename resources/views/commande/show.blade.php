                        ...
                        <div class="modal-body mx-3">
                            <form class="form-horizontal form-material" method="POST" action="{{route('commandeStatut',['id' => $commande->id])}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select id="etat" onchange="reporter()" name="statut" class="form-control form-control-line" value="{{ old('statut',$commande->statut) }}">
                                            <option>Livré</option>
                                ...
                                <div class="form-group" style="display: none" id="prevu">
                                    ...
                                    <div class="col-sm-12">
                                      <input class="form-control" name="prevu_at" type="date" id="datePrevu" type="date"
